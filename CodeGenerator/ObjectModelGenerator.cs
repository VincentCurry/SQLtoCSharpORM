                ...
                foreach (SQLTableColumn column in table.Columns)
                {
                    if (column.PrimaryKey)
                    {
                        if (column.DataType == SQLDataTypes.uniqueIdentifier)
                        {
                            ...
                            classText.AppendLine("{");
                            classText.AppendLine("this." + Library.LowerFirstCharacter(column.Name) + " = SQLDataServer.ExecuteSPReturnGuid(\"" + table.Name + "Insert\", parameters);");
                            classText.AppendLine("}");
                            ...
                            classText.AppendLine("SQLDataServer.ExecuteSP(\"" + table.Name + "Update\", parameters);");
                            classText.AppendLine("}");
                        }
                        else
                        {
                            ...
                            classText.AppendLine("{");
                            classText.AppendLine("this." + Library.LowerFirstCharacter(column.Name) + "= SQLDataServer.ExecuteSPReturnLong(\"" + table.Name + "Insert\", parameters, \"@" + column.Name + "\");");
                            classText.AppendLine("}");
                            classText.AppendLine("else");
                            classText.AppendLine("{");
